...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-base-ssyr/tags). For example,

```javascript
ssyr = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-ssyr@v0.1.1-umd/browser.js' )
```
